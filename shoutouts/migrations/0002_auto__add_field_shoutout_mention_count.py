...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShoutOut.mention_count'
        db.add_column(u'shoutouts_shoutout', 'mention_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShoutOut.mention_count'
        db.delete_column(u'shoutouts_shoutout', 'mention_count')
    ...
    models = {
        ...
        u'shoutouts.shoutout': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mention_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
